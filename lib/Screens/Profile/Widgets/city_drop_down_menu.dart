...
class CityDroDown extends StatefulWidget {
  final String city;
  const CityDroDown({Key? key, required this.city}) : super(key: key);

  @override
  _CityDroDownState createState() => _CityDroDownState();
}

class _CityDroDownState extends State<CityDroDown> {
  int? selectedCityId;
  ...
  @override
  void didUpdateWidget(CityDroDown oldWidget) {
                    ...
                    : (value) async {
                        ...
                        try {
                          ...
                          final userController =
                              context.read<Userdatacontroller>();
                          userController
                            ..SetCity(selectedCity.nameEn)
