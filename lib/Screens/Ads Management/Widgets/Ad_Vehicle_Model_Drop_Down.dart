...
class AdVehiclemodeldropdown extends StatefulWidget {
  final String brad;

  const AdVehiclemodeldropdown({Key? key, required this.brad})
      : super(key: key);

  @override
  _AdVehiclemodeldropdownState createState() => _AdVehiclemodeldropdownState();
}

class _AdVehiclemodeldropdownState extends State<AdVehiclemodeldropdown> {
  int? selectedBrandId;
  ...
  @override
  void didUpdateWidget(AdVehiclemodeldropdown oldWidget) {
  ...
  Future<void> _handleModelChange(int? value) async {
    ...
    try {
      final vehicleData = Provider.of<MyAdController>(context, listen: false);
      final controller = Provider.of<MyAdController>(context, listen: false);
