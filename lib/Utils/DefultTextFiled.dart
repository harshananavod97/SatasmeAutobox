        ...
        return (s) {
          ...
          if (s.trim().length < 10)
            return widget.errorMinimumPasswordLength
                .validate(value: 'Minimum password length should be ');
          return null;
        };
        ...
        return (s) {
          ...
          if (!s.trim().validatePhone()) {
            return widget.errorInvalidEmail
                .validate(value: 'Phone number must be 9 or 10 digits');
          }

          return null;
        };
      } else if (widget.textFieldType == TextFieldType.PRICE) {
        return (s) {
          if (s!.trim().isEmpty) {
            return widget.errorThisFieldRequired
                .validate(value: errorThisFieldRequired);
          ...
          if (!s.trim().validatePrice()) {
            return widget.errorInvalidEmail.validate(value: 'numbers only add');
          }
